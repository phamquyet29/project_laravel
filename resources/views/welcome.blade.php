  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-evenly" id="navbarTogglerDemo03">
          ...
          <button type="button" class="btn btn-danger" id="cartButton">
    ...
    <main role="main" class="container ">
      <div class="row row-cols-1 row-cols-md-5 g-4">
        ...
        <div class="col">
          <div class="card">
            <img class="w-100" src={{ $product->image }} class="card-img-top"
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-colunm justify-content-center">
                <a href="{{ route('cart.add', ['productId' => $product->id]) }}" class="btn bg-danger text-white">Add to Cart</a>
              </div>
            </div>
