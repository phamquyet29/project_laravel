                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-sm-6">
                                <div class="white-box text-center"><img src="{{ $product->image }}"
                                        class="img-responsive w-50 pt-5 mt-5"></div>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-6">
                                ...
                                <a href="/paypal"><button class="btn btn-warning text-white btn-rounded">Buy
                                        Now</button></a>
